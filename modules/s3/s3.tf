# Random ID to append to the S3 bucket name for uniqueness
resource "random_id" "bucket_suffix" {
  byte_length           = 8
}

#  S3 bucket with a unique name based on the provided `bucket_name` 
...
#  S3 bucket access control list (ACL) to private
